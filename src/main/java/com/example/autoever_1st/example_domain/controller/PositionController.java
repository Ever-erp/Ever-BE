...
import com.example.autoever_1st.example_domain.dto.res.PositionResDto;
...
@RequestMapping("/mock/position")
public class PositionController {
    @GetMapping("/test")
    public PositionResDto mockPosition() {
        PositionResDto positionResDto = new PositionResDto();
        positionResDto.setRole("관리자");
