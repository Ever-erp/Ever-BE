package com.ever.autoever_1st.auth.service.impl;
...
import com.ever.autoever_1st.auth.entities.RefreshToken;
...
import com.ever.autoever_1st.auth.repository.RefreshTokenRepository;
...
public class AuthServiceImpl implements AuthService {
    ...
    public MemberResponseDto signup(MemberReqDto memberReqDto) {
        ...
        Optional<Position> defaultPosition = positionRepository.findByRole("ROLE_학생");
